...
let mySprite = sprites.create(assets.image`Manny Heffley`, SpriteKind.Player)
...
info.setLife(3)
forever(function () {
    mySprite2 = sprites.create(assets.image`Manny Heffley`, SpriteKind.Enemy)
    mySprite2.x = -20
    mySprite2.y = randint(20, 150)
})
